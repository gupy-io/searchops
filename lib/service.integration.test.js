...
language_1.context("SearchService @integration", () => {
    language_1.test("Creating new documents", (_) => {
    ...
    language_1.test("Creating new deeply nested fields", (_) => {
        _.givenTheIndex().wasCreated();
        _.givenTheDocument()
    ...
    language_1.test("Updating old fields", (_) => {
        _.givenTheIndex().wasCreated();
        _.givenTheDocument()
    ...
    language_1.test("Updating old deeply nested fields", (_) => {
        _.givenTheIndex().wasCreated();
        _.givenTheDocument()
            .containing({
            author: {
    ...
    language_1.test("Counting documents", (_) => {
        _.givenTheIndex().wasCreated();
