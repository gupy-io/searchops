...
// plug into mocha
const context = globals_1.describe;
const exercise = globals_1.test;
const fakeLogger = {
...
class CountSteps {
    ...
    shouldBe(count) {
        ...
        this.testWorld.expectationChecks.push(() => globals_1.expect(this.testWorld.count).toEqual(count));
        return this;
    }
}
class DocumentSteps {
    ...
    shouldContain(parts) {
        ...
        this.testWorld.expectationChecks.push(() => {
            ...
            globals_1.expect(intersection).toEqual(parts);
        });
        return this;
    }
}
...
class Scenario {
    ...
    build() {
        context(this.testWorld.context, () => {
            // this.testWorld.contextSetup.forEach((setUp) => beforeAll(setUp));
